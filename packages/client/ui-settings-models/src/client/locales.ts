...
export const en = {
  ...
  nativeReplayDisable: 'Do not send encrypted Responses state on later requests',
  nativeReplayHint: 'Use this for OpenAI-compatible providers that reject encrypted reasoning or signature metadata.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customApi: 'API 协议',
  customApiUnset: '未选择',
  nativeReplayDisable: '后续请求不发送加密的 Responses 状态',
  nativeReplayHint: '用于会拒绝加密推理或签名元数据的 OpenAI 兼容提供方。',
