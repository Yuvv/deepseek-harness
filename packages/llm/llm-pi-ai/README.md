...
| `nativeReplay` | `true` | Preserve provider-native replay metadata; set `false` for OpenAI-compatible Responses gateways that reject encrypted state |
